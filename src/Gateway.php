...
class Gateway extends AbstractGateway
{
    ...
    public function getDefaultParameters()
    {
        return array(
            ...
            'testMode'          => false,
            'developerMode'     => false,
            'liveEndpoint'      => 'https://app.bluedogpayments.com/api',
            'developerEndpoint' => 'https://sandbox.bluedogpayments.com/api',
        );
    }
     ...
     * @return \Omnipay\BlueDog\Message\AuthorizeRequest
     */
    public function authorize(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\BlueDog\Message\AuthorizeRequest', $parameters);
    }
